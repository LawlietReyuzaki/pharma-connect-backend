...
class SmartRAGOrchestrator:
    ...
    def retrieve(self, user_query: str, language: str = "en") -> Dict:
        ...
        try:
            ...
            result['extracted_keywords'] = {
                'primary': extracted.primary_keyword,
                'wiki_keywords': extracted.wiki_keywords,
                'medicine_keywords': extracted.medicine_keywords,
    ...
    def _retrieve_fallback(self, user_query: str) -> Dict:
        """Fallback retrieval if enhanced agent fails"""
        result = {
            'medications': [],
            'wiki_context': None,
            'images': [],
