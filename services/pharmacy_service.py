...
def pharmacy_to_dict(pharmacy, distance=None):
    ...
    data = {
        ...
        'owner_photo_path': pharmacy.owner_photo_path or '/static/images/default-pharmacy.png',
        'pharmacy_photo_path': pharmacy.pharmacy_photo_path or '/static/images/default-pharmacy.png',
